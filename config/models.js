...
module.exports.models = {
  ...
  attributes: {
    ...
    createdBy: { type: 'string', columnType: 'VARCHAR(40)' },
    updatedBy: { type: 'string', columnType: 'VARCHAR(40)', allowNull: true },
    deletedBy: { type: 'string', columnType: 'VARCHAR(40)', allowNull: true },
  ...
  dataEncryptionKeys: {
    default: 'BK197brUsahz52YRA3cM4vt6eHYQ7ZdGBLKhDOhSmzM=',
  },
